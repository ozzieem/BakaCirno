...
namespace BulletHell
{
    ...
    internal class Player
    {
        ...
        public void LoadPlayer(ContentManager content)
        {
            ...
            bulletBBoxTexture = content.Load<Texture2D>("../assets/textures/Redshot");
            pointBBoxTexture = content.Load<Texture2D>("../assets/textures/enemy_3");
        ...
        private void Shoot()
        {
            if (powerShot)
            {
                currBulletTexture = powerShotTexture;
            }
            else
            {
                currBulletTexture = bulletTexture;
            }
